  ...
  return (
    <>
      <nav className="w-full absolute left-0 z-20 flex py-6 justify-between items-center navbar px-6">
        ...
        <div className="menu sm:hidden flex flex-1 justify-end items-center">
          <img
            src={toggle ? close : menu}
            alt="menu"
            className="w-[28px] h-[28px] object-contain hover:scale-110 my-transition"
      ...
      <div className="dark-gradient absolute top-0 left-0 w-full h-[40vh] bg-gradient-to-b from-black to-transparent z-10 opacity-60"></div>
    </>
  );
};
